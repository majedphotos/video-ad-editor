...
12. **مصدر آيفون HDR → تحويل صحيح إلزامي** (`03_cut_zoom.py` يكشفه: محوّل أبل على ماك، وتونماب ffmpeg على ويندوز/لينكس) — التحويل الساذج يبهّت الألوان ويرفع الظلال (لمسة كريمية)؛ لو شكّيت قِس متوسط لون البشرة بين المصدر والناتج.
