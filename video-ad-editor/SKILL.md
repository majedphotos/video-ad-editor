...
يشتغل عبر **Claude Code على ماك** (الوضع المحلي): يحتاج ffmpeg وموديل وِسبر (ينزل من openaipublic.azureedge.net) ومتصفحاً للرسم ومكتبة Vision للقصّ. **داخل تطبيق كلود بالسحابة (الساندبوكس) ما يشتغل**: تنزيل الموديل محجوب وما فيه متصفح. لو شغّله أحد من التطبيق وطلعت له رسالة عن host محجوب، الجواب: «افتح Claude Code على جهازك واختر Local وشغّل نفس الأمر». `00_setup.sh` يكتشف هذا ويوقف برسالة واضحة.
